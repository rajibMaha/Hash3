...
const JDataFromFile = require("../model/data.json");
...
const initilizedApp = (rootele) => {
  root = rootele;
};

const Run = () => {
  callApp(JDataFromFile);
};

export const appPublic = {
  publicinItilizedApp: initilizedApp,
  publicRun: Run,
  publicMgetDuplicate: getDuplicate,
  publicMgetInnerText: getInnerText,
  publicCallApp: callApp,
  PublicGetDuplicateIDAndNull: getDuplicateIDAndNull,
};
